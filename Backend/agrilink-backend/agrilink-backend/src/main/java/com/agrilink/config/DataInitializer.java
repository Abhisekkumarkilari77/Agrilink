...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedDefaultProducts(List<User> farmers) {
        ...
        nonUnsplashImages.put("Tomato", "https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=500&q=80");
        nonUnsplashImages.put("Potato", "https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=500&q=80");
        nonUnsplashImages.put("Onion", "https://images.unsplash.com/photo-1618512496248-a07fe83aa8cf?w=500&q=80");
        nonUnsplashImages.put("Brinjal", "https://images.unsplash.com/photo-1628751050140-09c59d871987?w=500&q=80");
        nonUnsplashImages.put("Bottle Gourd", "https://images.unsplash.com/photo-1603048588665-791ca8aea617?w=500&q=80");
        nonUnsplashImages.put("Bitter Gourd", "https://images.unsplash.com/photo-1587334206574-351ecdb77485?w=500&q=80");
        nonUnsplashImages.put("Cauliflower", "https://images.unsplash.com/photo-1568584711271-e0037e23112b?w=500&q=80");
        nonUnsplashImages.put("Cabbage", "https://images.unsplash.com/photo-1608686207856-001b95cf60ca?w=500&q=80");
        nonUnsplashImages.put("Capsicum", "https://images.unsplash.com/photo-1566842600175-e76042b39418?w=500&q=80");
        nonUnsplashImages.put("Carrot", "https://images.unsplash.com/photo-1598170845058-12ef4a457c3b?w=500&q=80");
        nonUnsplashImages.put("Beans", "https://images.unsplash.com/photo-1567375699048-52224b459ccf?w=500&q=80");
        nonUnsplashImages.put("Beetroot", "https://images.unsplash.com/photo-1587334206574-351ecdb77485?w=500&q=80");
        nonUnsplashImages.put("Radish", "https://images.unsplash.com/photo-1590004953392-5aba2e72269a?w=500&q=80");
        nonUnsplashImages.put("Spinach", "https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=500&q=80");
        ...
        nonUnsplashImages.put("Coriander", "https://images.unsplash.com/photo-1588879460618-9249e7d947d1?w=500&q=80");
        nonUnsplashImages.put("Drumstick", "https://images.unsplash.com/photo-1628134714488-66270725a371?w=500&q=80");
        nonUnsplashImages.put("Lady Finger", "https://images.unsplash.com/photo-1625943553852-781c1ff8aef4?w=500&q=80");
        nonUnsplashImages.put("Green Chilli", "https://images.unsplash.com/photo-1588252303782-cb80119abd6d?w=500&q=80");

        nonUnsplashImages.put("Mango", "https://images.unsplash.com/photo-1553279768-865429fa0078?w=500&q=80");
        nonUnsplashImages.put("Banana", "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=500&q=80");
        nonUnsplashImages.put("Apple", "https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=500&q=80");
        nonUnsplashImages.put("Orange", "https://images.unsplash.com/photo-1547514701-42782101795e?w=500&q=80");
        nonUnsplashImages.put("Papaya", "https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=500&q=80");
        nonUnsplashImages.put("Watermelon", "https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=500&q=80");
        nonUnsplashImages.put("Guava", "https://images.unsplash.com/photo-1534482421-64566f976cfa?w=500&q=80");
        nonUnsplashImages.put("Pomegranate", "https://images.unsplash.com/photo-1541348263662-e0c8643c21ec?w=500&q=80");
        nonUnsplashImages.put("Dragon Fruit", "https://images.unsplash.com/photo-1527325678964-54921661f888?w=500&q=80");
        nonUnsplashImages.put("Pineapple", "https://images.unsplash.com/photo-1550258987-190a2d41a8ba?w=500&q=80");

        nonUnsplashImages.put("Rice", "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500&q=80");
        nonUnsplashImages.put("Wheat", "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=500&q=80");
        nonUnsplashImages.put("Foxtail Millet", "https://images.unsplash.com/photo-1599940824399-b87987ceb72a?w=500&q=80");
        nonUnsplashImages.put("Pearl Millet", "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=500&q=80");
        nonUnsplashImages.put("Ragi", "https://images.unsplash.com/photo-1509358271058-acd22cc93898?w=500&q=80");

        nonUnsplashImages.put("Rajma", "https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=500&q=80");
        nonUnsplashImages.put("Green Gram", "https://images.unsplash.com/photo-1600611422773-cbcfdfb7310d?w=500&q=80");
        nonUnsplashImages.put("Black Gram", "https://images.unsplash.com/photo-1599940824399-b87987ceb72a?w=500&q=80");
        nonUnsplashImages.put("Toor Dal", "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500&q=80");
        nonUnsplashImages.put("Bengal Gram", "https://images.unsplash.com/photo-1542838132-92c53300491e?w=500&q=80");

        nonUnsplashImages.put("Turmeric", "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=500&q=80");
        nonUnsplashImages.put("Black Pepper", "https://images.unsplash.com/photo-1508737027454-e6454ef45afd?w=500&q=80");
        nonUnsplashImages.put("Cardamom", "https://images.unsplash.com/photo-1532132644265-5152865c6978?w=500&q=80");
        nonUnsplashImages.put("Coriander Seeds", "https://images.unsplash.com/photo-1596797038530-2c107229654b?w=500&q=80");
        nonUnsplashImages.put("Cumin", "https://images.unsplash.com/photo-1509358271058-acd22cc93898?w=500&q=80");

        nonUnsplashImages.put("Milk", "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=500&q=80");
        nonUnsplashImages.put("Paneer", "https://images.unsplash.com/photo-1528750997573-59b89d66f4f7?w=500&q=80");
        nonUnsplashImages.put("Butter", "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=500&q=80");
        nonUnsplashImages.put("Cheese", "https://images.unsplash.com/photo-1486299267070-83823f5448dd?w=500&q=80");
        nonUnsplashImages.put("Honey", "https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=500&q=80");
        nonUnsplashImages.put("Ghee", "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=500&q=80");
